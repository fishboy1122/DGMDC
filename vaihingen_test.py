...
def get_args():
    ...
    arg("-c", "--config_path", type=Path, help="Path to config" ,default="config/vaihingen/DGMDC_config.py" )
    arg("-o", "--output_path", type=Path, help="Path where to save resulting masks." ,default="T2003057/yyc/GeoSeg-main/GeoSeg-main/fig_results/val")
    arg("-t", "--tta", help="Test time augmentation.", default="d4", choices=[None, "d4", "lr"])
    arg("--rgb", help="whether output rgb images",default="rgb", action='store_true')
