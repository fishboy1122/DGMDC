...
loveda_val_dataset = LoveDATrainDataset(data_root='/T2007061/yyc_worksapce/data/loveda/Val', mosaic_ratio=0.0,
                                        transform=val_aug)


class LoveDATestDataset(Dataset):
    def __init__(self, data_root='/T2007061/yyc_worksapce/data/loveda/Test', img_dir='images_png',
