...
class UAVIDDataset(Dataset):
    def __init__(self, data_root='/T2007061/yyc_worksapce/data/uavid/val', mode='val', img_dir='images', mask_dir='masks',
...
class UAVIDDatasetV2(Dataset):
    def __init__(self, data_root='/T2007061/yyc_worksapce/data/uavid/val', mode='val', img_dir='images_512', mask_dir='masks_512',
                 img_suffix='.png', mask_suffix='.png', transform=val_aug, mosaic_ratio=0.0,
