...
def parse_args():
    ...
    parser.add_argument("--input-dir", default="/T2003057/yyc/uavid_v1.5_official_release_image/uavid_v1.5_official_release_image/uavid_test")
    parser.add_argument("--output-img-dir", default="/T2003057/yyc/data/uavid/test/images")
    parser.add_argument("--output-mask-dir", default="/T2003057/yyc/data/uavid/test/masks")
...
if __name__ == "__main__":
    ...
    t0 = time.time()
    mpp.Pool(processes=mp.cpu_count()).map(patch_format, iterable=inp)
    t1 = time.time()
    split_time = t1 - t0
