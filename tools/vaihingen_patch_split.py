...
def parse_args():
    ...
    parser.add_argument("--img-dir", default="data/vaihingen/test/test_images")
    parser.add_argument("--mask-dir", default="data/vaihingen/test/test_masks_eroded")
...
if __name__ == "__main__":
    ...
    t0 = time.time()
    print(mask_paths_raw)
    mpp.Pool(processes=mp.cpu_count()).map(vaihingen_format, iterable=(inp))
    t1 = time.time()
    split_time = t1 - t0
